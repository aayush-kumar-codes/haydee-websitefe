            ...
            <div className="p-5">
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium mt-2 ${week.validation_status ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                            }`}>
                            {week.validation_status ? 'Approved' : 'Pending'}
                        </div>
                    </div>
                    <button
